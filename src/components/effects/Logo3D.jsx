 ...
 */
export default function Logo3D({ style }) {
    ...
    useEffect(() => {
        ...
        /* ── Material: dark charcoal with slight sheen ── */
        const mat = new THREE.MeshStandardMaterial({
            color: new THREE.Color('#1a1a1a'),   // slightly darker sophisticated charcoal
            metalness: 0.6,
            roughness: 0.45,                     // tightened roughness for a cleaner, polished gleam
        });

        /* ── Highlight/specular accent layer (thinner clone, cream) ── */
