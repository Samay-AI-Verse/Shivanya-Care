            ...
            <div style={{ position: 'relative', width: '260px', height: '500px' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div>
                            <div style={{ color: '#f4ede6', fontWeight: 700, fontSize: '0.78rem', fontFamily: "'Outfit', sans-serif" }}>Shivanya RxAI</div>
                    ...
                    <div style={{ flex: 1, overflowY: 'hidden', padding: '10px 12px', display: 'flex', flexDirection: 'column', gap: '9px' }}>
                        ...
                        {/* SMS */}
                        <div style={{ background: 'rgba(200,223,160,0.10)', border: '1px solid rgba(200,223,160,0.25)', borderRadius: '16px', padding: '11px 14px', display: 'flex', alignItems: 'center', gap: '11px' }}>
                            <div style={{ width: '38px', height: '38px', borderRadius: '12px', flexShrink: 0, background: 'linear-gradient(135deg, #8ab840, #5a8a28)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 12px rgba(138,184,64,0.4)' }}>
                                <i className="ri-message-2-line" style={{ color: '#fff', fontSize: '1.2rem' }} />
                            </div>
                            <div style={{ flex: 1, minWidth: 0 }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <span style={{ color: '#c8dfa0', fontSize: '0.72rem', fontWeight: 700, fontFamily: "'Outfit', sans-serif" }}>SMS Alert</span>
                                    <span style={{ color: '#f4ede6', opacity: 0.4, fontSize: '0.58rem' }}>3m ago</span>
                                </div>
                                <p style={{ color: '#f4ede6', opacity: 0.8, fontSize: '0.68rem', margin: '2px 0 0', lineHeight: 1.4, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                    Rx#40821 ready. Reply STOP to opt out.
                                </p>
                            </div>
                        </div>
                ...
                {/* SMS — bottom-right offset */}
                <div className="hidden sm:flex" style={{
                    position: 'absolute', right: '-65px', bottom: '150px', zIndex: 20,
                    height: '50px', padding: '0 20px 0 14px', borderRadius: '16px',
                    background: 'linear-gradient(135deg, #8ab840, #5a8a28)',
                    alignItems: 'center', justifyContent: 'center', gap: '8px',
                    boxShadow: '0 15px 35px rgba(138,184,64,0.4), inset 0 3px 6px rgba(255,255,255,0.4), inset 0 -4px 10px rgba(0,0,0,0.25)',
                    border: '1px solid rgba(255,255,255,0.3)',
                    transform: 'rotate(-4deg)'
                }}>
                    <i className="ri-message-2-line" style={{ color: '#fff', fontSize: '1.4rem', filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }} />
                    <span style={{ color: '#fff', fontWeight: 700, fontFamily: "'Outfit', sans-serif", fontSize: '0.85rem', textShadow: '0 2px 4px rgba(0,0,0,0.3)' }}>SMS Alert</span>
                </div>
