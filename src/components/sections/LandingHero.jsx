                ...
                >
                    ...
                    <div className="hero-text" style={{
                        ...
                        <h1 style={{
                            ...
                            Shivanya
                            <span style={{ fontFamily: "Georgia, serif", fontStyle: 'italic', fontWeight: 700, fontSize: '0.62em', color: '#f4ede6', letterSpacing: '-0.01em', marginLeft: '6px' }}>Rx</span>
                            <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 300, fontSize: '0.62em', color: '#f4ede6', letterSpacing: '0.04em' }}>AI</span>
